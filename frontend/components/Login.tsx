  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        const userData = data.user; // expected to contain { id, name, email }
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          required
        />
        <div className="absolute inset-y-0 top-5 right-0 flex items-center pr-3">
          <button
            type="button"
        ...
        <button
          onClick={(e) => {
            ...
            if (onContentTypeChange) {
              onContentTypeChange("forgetPassword");
            }
          }}
