...
// Helper function to get image URL from string or StaticImageData
const getImgSrc = (img: string | StaticImageData | undefined): string => {
  if (!img) return "";
        ...
        >
          ...
          {showHandlebar && (
            <div className="h-5 w-5 rounded-md top-1/2 -translate-y-1/2 bg-white z-30 -right-2.5 absolute flex items-center justify-center shadow-[0px_-1px_0px_0px_#FFFFFF40]">
              <HiDotsVertical className="h-4 w-4 text-black" />
            </div>
          )}
        </motion.div>
      </AnimatePresence>
